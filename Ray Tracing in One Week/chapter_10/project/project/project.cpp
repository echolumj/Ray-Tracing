...
int main()
{
	...
	camera* myCamera = new camera(vec3(-2,2,1), vec3(0,0,-1), vec3(0,1,0),90, IMAGE_WIDTH/IMAGE_HEIGHT);

	hitable *list[OBJECT_NUM];
	list[0] = new sphere(vec3(0, 0, -1), 0.5, new lambertian(vec3(0.8, 0.3, 0.3)));
	list[1] = new sphere(vec3(0, -100.5, -1), 100, new lambertian(vec3(0.8, 0.8, 0.0)));
	list[2] = new sphere(vec3(1, 0, -1), 0.5, new metal(vec3(0.8, 0.6, 0.2), 0.0));
	list[3] = new sphere(vec3(-1, 0, -1), 0.5, new dielectrics(1.5));
	list[4] = new sphere(vec3(-1, 0, -1), -0.45, new dielectrics(1.5));
